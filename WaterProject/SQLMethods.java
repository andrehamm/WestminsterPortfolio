...
public class SQLMethods {
   ...
   */
  public String[] waterUsedInFiscalYear(int startYear, int endYear){
    int year = startYear;
    ...
    for(int i = 0; i <= (endYear - startYear); i++){
      ...
      "-07-01' and serviceTo <= '" + (year+1) + "-06-30';";
   ...
   */
  public String[] waterUsedInFiscalYearByAccount(int startYear, int endYear, int accountNum){
    int year = startYear;
    String[] queries = new String[(endYear-startYear) + 1];
    ...
    for(int i = 0; i <= (endYear - startYear); i++){
      ...
      //format the query
      String query = "Select sum(billingUnits*748) AS gallons, sum(totalCharges) From Invoice Where serviceFrom >= '" + year + 
      "-07-01' and serviceTo <= '" + (year+1) + "-06-30' and accountNum = " + accountNum + ";"; 
   ...
   */
  public String[] waterUsedByMonth(int startYear, int endYear, int month){
    int year = startYear;
    String[] queries = new String[(endYear-startYear) + 1];
